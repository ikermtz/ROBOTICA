...
if __name__ == '__main__':
    try:
        ...
        # Mover a la configuración base
        print("Moviendo a la configuración base...")
        control.moverConfigBase()
        print(control.get_motor_angles())
        
        # Abrir la pinza
        print("Abriendo la pinza...")
        if control.mover_pinza(100.0, 5.0):  # Abrir a 10cm con 40N de fuerza
            print("Pinza abierta correctamente")
        else:
            print("Error al abrir la pinza")
        ...
        if control.mover_pinza(60.5, 5.0):  # Cerrar completamente con 40N de fuerza
            print("Pinza cerrada correctamente")
        else:
            print("Error al cerrar la pinza")

          # Volver a la configuración base
        print("Volviendo a la configuración base...")
        control.moverConfigBase()
